...
fn movement_system(time: Res<Time>, mut moving_q: Query<(&mut Transform, &Velocity)>)
{
...
fn acceleration_system(time: Res<Time>, mut accel_q: Query<(&mut Velocity, &Acceleration)>)
{
